...
export const ComprobantePagoVentas = () => {
    ...
    const statusColumns: ColumnDef<ComprobanteSelectDto>[] = [
        {
            key: 'estado', header: 'Estado', sortable: true, width: '56px', align: 'center', className: 'col-status',
            render: row => <ComprobanteStatusBadge status={row.estado} />,
        },
        {
            key: 'estadoSunat', header: 'SUNAT', sortable: true, width: '56px', align: 'center', className: 'col-status',
                ...
                filterPanel={
                    <>
                        <div className="erp-filter-group">
                            <label className="erp-filter-label">Tipo de Comprobante</label>
    ...
    return (
        <>
            <SubmoduleTwoTabsLayout
                ...
                subtitle="Emisión de boletas y facturas electrónicas"
